const wordList = [
  ...
  { word: "saturn", hint: "planet with prominent rings" },
  { word: "amazon", hint: "massive e-commerce platform" },
  { word: "linux", hint: "open-source operating system" },
  { word: "docker", hint: "container platform for apps" },
  { word: "mona", hint: "famous da vinci painting" },
  { word: "router", hint: "networking hardware device" },
  { word: "copper", hint: "reddish-brown conductive metal" },
  { word: "tokyo", hint: "capital city of japan" },
  { word: "oasis", hint: "fertile spot in a desert" },
  { word: "safari", hint: "web browser by apple" },
  ...
  { word: "sqlite", hint: "lightweight embedded database" },
  { word: "brazil", hint: "largest south american country" },
  { word: "kernel", hint: "core component of an os" },
